import{g as i,x as w,c as u,o as d,k as f,a as n,e as y,u as l,t as m,i as S,v as C,y as P,j as H,z as L,_ as $,b as j}from"./4CBco2bD.js";import{u as T}from"./AVDwNBwj.js";const A={class:"mac-window w-full h-[32rem] overflow-hidden"},B={class:"terminal h-full"},I={class:"terminal-content"},R={key:0,class:"output whitespace-pre-wrap mb-2"},D={class:"flex items-center"},z={class:"text-muted"},W={__name:"TerminalWindow",setup(h){const e=i(""),a=i(""),r=i([]),v=i("[david~]$"),c=i(null),t={Help:"help",Clear:"clear",History:"history",About:"whoami",Resume:"skills",Projects:"projects"};w(()=>{e.value=`${p()}
