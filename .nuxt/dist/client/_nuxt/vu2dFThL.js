import{_ as S}from"./CutXkhW7.js";import{_ as W,c as r,o,a as t,l as p,w as g,t as i,g as f,F as b,m as k,d as v,r as _,p as y,u as a,h as B,v as L,j,e as $,q as A}from"./DssrbTyR.js";import{u as D}from"./Ch66X7Ep.js";const P={class:"bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden group"},R={class:"relative h-48 sm:h-64 overflow-hidden"},q=["src","alt"],M=["src","alt"],N={class:"absolute top-4 left-4"},z={class:"bg-secondary text-white px-3 py-1 rounded-full text-sm font-medium"},F={class:"p-6"},Z={class:"flex items-center text-sm text-gray-500 mb-3"},Q=["datetime"],U={class:"text-xl font-bold text-primary mb-3 line-clamp-2 hover:text-secondary transition-colors duration-200"},V={key:1,class:"text-xl font-bold text-primary mb-3 line-clamp-2"},G={class:"text-gray-600 mb-4 line-clamp-3"},H={key:2,class:"flex flex-wrap gap-2 mb-4"},O={class:"flex items-center justify-between"},E={key:1,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200 cursor-pointer"},Y={key:2,class:"text-sm text-gray-500"},J={__name:"BlogCard",props:{post:{type:Object,required:!0}},setup(s){const w=c=>new Date(c).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return(c,l)=>{const m=S;return o(),r("article",P,[t("div",R,[s.post.content?(o(),p(m,{key:0,to:`/blog/${s.post.slug}`,class:"block h-full cursor-pointer"},{default:g(()=>[t("img",{src:s.post.image,alt:s.post.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"},null,8,q)]),_:1},8,["to"])):(o(),r("img",{key:1,src:s.post.image,alt:s.post.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"},null,8,M)),t("div",N,[t("span",z,i(s.post.category),1)])]),t("div",F,[t("div",Z,[t("time",{datetime:s.post.date},i(w(s.post.date)),9,Q),l[0]||(l[0]=t("span",{class:"mx-2"},"•",-1)),t("span",null,i(s.post.readTime)+" min read",1)]),s.post.content?(o(),p(m,{key:0,to:`/blog/${s.post.slug}`,class:"block cursor-pointer"},{default:g(()=>[t("h3",U,i(s.post.title),1)]),_:1},8,["to"])):(o(),r("h3",V,i(s.post.title),1)),t("p",G,i(s.post.excerpt),1),s.post.tags&&s.post.tags.length?(o(),r("div",H,[(o(!0),r(b,null,k(s.post.tags,n=>(o(),r("span",{key:n,class:"bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium"}," #"+i(n),1))),128))])):f("",!0),t("div",O,[s.post.content?(o(),p(m,{key:0,to:`/blog/${s.post.slug}`,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200"},{default:g(()=>l[1]||(l[1]=[v(" Read More ",-1),t("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])),_:1,__:[1]},8,["to"])):(o(),r("div",E,l[2]||(l[2]=[v(" Coming Soon ",-1),t("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)]))),s.post.author?(o(),r("div",Y," by "+i(s.post.author),1)):f("",!0)])])])}}},K=W(J,[["__scopeId","data-v-2b14d6a4"]]),X=[{id:1,title:"One-on-one autopilot: the Zendesk → Slack cheat sheet",slug:"zendesk-slack-cheat-sheet",excerpt:"A lightweight bot that checks Google Calendar for upcoming 1:1s, pulls a focused Zendesk snapshot for the attendee, and posts a compact summary to Slack so managers arrive prepped without extra work.",content:`
    ...
    `,image:"/leadership-badge-1200x675-letterbox.png",category:"Leadership",tags:["leadership","management","team-culture","engineering"],date:"2025-08-11",lastUpdated:"2025-08-11",readTime:8,author:"David Larsen"}],tt={class:"max-w-6xl mx-auto"},et={key:0,class:"mb-16"},ot={class:"bg-white rounded-lg shadow-xl overflow-hidden"},at={class:"md:flex md:min-h-[400px]"},st={class:"md:w-1/2 md:flex"},nt=["src","alt"],rt=["src","alt"],it={class:"md:w-1/2 p-8 md:flex md:flex-col md:justify-center"},lt={class:"flex items-center text-sm text-gray-500 mb-4"},dt={class:"bg-secondary text-white px-3 py-1 rounded-full text-xs font-medium mr-4"},ht=["datetime"],ct={class:"text-2xl font-bold text-primary mb-4 hover:text-secondary transition-colors duration-200"},ut={key:1,class:"text-2xl font-bold text-primary mb-4"},pt={class:"text-gray-600 mb-6"},mt={key:2,class:"flex flex-wrap gap-2 mb-6"},gt={key:4,class:"bg-secondary text-white px-6 py-3 rounded-lg hover:bg-secondary/90 transition-colors duration-200 inline-flex items-center font-medium cursor-pointer"},ft={class:"mb-8"},wt={class:"flex flex-col sm:flex-row gap-4 items-center justify-between"},yt={class:"flex flex-wrap gap-2"},bt=["onClick"],kt={class:"relative"},vt={class:"grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12"},xt={key:1,class:"text-center py-12"},Tt={__name:"index",setup(s){D({title:"Blog",meta:[{name:"description",content:"David Larsen's blog on customer support, team leadership, technology, and professional insights from Baltimore."}]});const w=_(X),c=_("All"),l=_(""),m=y(()=>[...w.value].sort((h,e)=>new Date(e.date)-new Date(h.date))),n=y(()=>m.value[0]||null),C=y(()=>["All",...new Set(w.value.map(e=>e.category))]),I=y(()=>{let h=m.value.slice(1);if(c.value!=="All"&&(h=h.filter(e=>e.category===c.value)),l.value){const e=l.value.toLowerCase();h=h.filter(u=>u.title.toLowerCase().includes(e)||u.excerpt.toLowerCase().includes(e)||u.tags.some(x=>x.toLowerCase().includes(e)))}return h}),T=h=>new Date(h).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return(h,e)=>{const u=S,x=K;return o(),r("div",tt,[e[7]||(e[7]=t("div",{class:"text-center mb-12"},[t("h1",{class:"text-4xl font-bold text-primary mb-4"},"Blog"),t("p",{class:"text-xl text-gray-600 max-w-2xl mx-auto"}," Thoughts on work and whatever I find interesting. ")],-1)),a(n)?(o(),r("div",et,[e[4]||(e[4]=t("h2",{class:"text-2xl font-semibold text-primary mb-6"},"Featured Post",-1)),t("div",ot,[t("div",at,[t("div",st,[a(n).content?(o(),p(u,{key:0,to:`/blog/${a(n).slug}`,class:"block cursor-pointer w-full"},{default:g(()=>[t("img",{src:a(n).image,alt:a(n).title,class:"w-full h-64 md:h-full md:min-h-[400px] object-cover hover:scale-105 transition-transform duration-300"},null,8,nt)]),_:1},8,["to"])):(o(),r("img",{key:1,src:a(n).image,alt:a(n).title,class:"w-full h-64 md:h-full md:min-h-[400px] object-cover"},null,8,rt))]),t("div",it,[t("div",lt,[t("span",dt,i(a(n).category),1),t("time",{datetime:a(n).date},i(T(a(n).date)),9,ht),e[1]||(e[1]=t("span",{class:"mx-2"},"•",-1)),t("span",null,i(a(n).readTime)+" min read",1)]),a(n).content?(o(),p(u,{key:0,to:`/blog/${a(n).slug}`,class:"block cursor-pointer"},{default:g(()=>[t("h3",ct,i(a(n).title),1)]),_:1},8,["to"])):(o(),r("h3",ut,i(a(n).title),1)),t("p",pt,i(a(n).excerpt),1),a(n).tags?(o(),r("div",mt,[(o(!0),r(b,null,k(a(n).tags,d=>(o(),r("span",{key:d,class:"bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm"}," #"+i(d),1))),128))])):f("",!0),a(n).content?(o(),p(u,{key:3,to:`/blog/${a(n).slug}`,class:"bg-secondary text-white px-6 py-3 rounded-lg hover:bg-secondary/90 transition-colors duration-200 inline-flex items-center font-medium"},{default:g(()=>e[2]||(e[2]=[v(" Read Full Article ",-1),t("svg",{class:"w-5 h-5 ml-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])),_:1,__:[2]},8,["to"])):(o(),r("div",gt,e[3]||(e[3]=[v(" Coming Soon ",-1),t("svg",{class:"w-5 h-5 ml-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])))])])])])):f("",!0),t("div",ft,[t("div",wt,[t("div",yt,[(o(!0),r(b,null,k(a(C),d=>(o(),r("button",{key:d,onClick:_t=>c.value=a(c)===d?"All":d,class:A(["px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200",a(c)===d?"bg-secondary text-white":"bg-gray-100 text-gray-700 hover:bg-gray-200"])},i(d),11,bt))),128))]),t("div",kt,[B(t("input",{"onUpdate:modelValue":e[0]||(e[0]=d=>j(l)?l.value=d:null),type:"text",placeholder:"Search posts...",class:"pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent"},null,512),[[L,a(l)]]),e[5]||(e[5]=t("svg",{class:"absolute left-3 top-2.5 h-5 w-5 text-gray-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1))])])]),t("div",vt,[(o(!0),r(b,null,k(a(I),d=>(o(),p(x,{key:d.id,post:d},null,8,["post"]))),128))]),a(I).length===0?(o(),r("div",xt,e[6]||(e[6]=[$('<div class="text-gray-400 mb-4"><svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div><h3 class="text-xl font-medium text-gray-600 mb-2">No posts found</h3><p class="text-gray-500">Try adjusting your search or filter criteria.</p>',3)]))):f("",!0)])}}};export{Tt as default};
