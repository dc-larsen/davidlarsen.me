import{_ as S}from"./B9MCMU3U.js";import{_ as B,c as a,o as s,a as e,t as i,e as h,F as y,r as w,f as _,w as T,d as v,g as k,h as f,u as o,i as I,v as D,j as P,k as A,n as j}from"./D3jyeTH7.js";import{u as R}from"./CTy5Gifx.js";const W={class:"bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden group"},M={class:"relative h-48 sm:h-64 overflow-hidden"},$=["src","alt"],q={class:"absolute top-4 left-4"},F={class:"bg-secondary text-white px-3 py-1 rounded-full text-sm font-medium"},N={class:"p-6"},H={class:"flex items-center text-sm text-gray-500 mb-3"},V=["datetime"],z={class:"text-xl font-bold text-primary mb-3 line-clamp-2 group-hover:text-secondary transition-colors duration-200"},Q={class:"text-gray-600 mb-4 line-clamp-3"},U={key:0,class:"flex flex-wrap gap-2 mb-4"},O={class:"flex items-center justify-between"},E={key:1,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200 cursor-pointer"},G={key:2,class:"text-sm text-gray-500"},K={__name:"BlogCard",props:{post:{type:Object,required:!0}},setup(r){const m=u=>new Date(u).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return(u,l)=>{const g=S;return s(),a("article",W,[e("div",M,[e("img",{src:r.post.image,alt:r.post.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"},null,8,$),e("div",q,[e("span",F,i(r.post.category),1)])]),e("div",N,[e("div",H,[e("time",{datetime:r.post.date},i(m(r.post.date)),9,V),l[0]||(l[0]=e("span",{class:"mx-2"},"•",-1)),e("span",null,i(r.post.readTime)+" min read",1)]),e("h3",z,i(r.post.title),1),e("p",Q,i(r.post.excerpt),1),r.post.tags&&r.post.tags.length?(s(),a("div",U,[(s(!0),a(y,null,w(r.post.tags,n=>(s(),a("span",{key:n,class:"bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium"}," #"+i(n),1))),128))])):h("",!0),e("div",O,[r.post.content?(s(),_(g,{key:0,to:`/blog/${r.post.slug}`,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200"},{default:T(()=>l[1]||(l[1]=[v(" Read More ",-1),e("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])),_:1,__:[1]},8,["to"])):(s(),a("div",E,l[2]||(l[2]=[v(" Coming Soon ",-1),e("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)]))),r.post.author?(s(),a("div",G," by "+i(r.post.author),1)):h("",!0)])])])}}},Z=B(K,[["__scopeId","data-v-e32211e5"]]),X=[{id:1,title:"Thoughts on leadership",slug:"thoughts-on-leadership",excerpt:"Short version: I try to make good work easier. Set the intent, raise the floor, and get out of the way. A deep dive into leader-leader thinking and practical approaches to engineering leadership.",content:`
      <blockquote>
    ...
    `,image:"/thoughts-on-leadership.png",category:"Leadership",tags:["leadership","management","team-culture","engineering"],date:"2025-08-11",lastUpdated:"2025-08-11",readTime:8,author:"David Larsen"},{id:2,title:"Building High-Performance Support Teams in 2025",slug:"building-high-performance-support-teams-2025",excerpt:"Learn the key strategies for scaling customer support teams while maintaining quality and team satisfaction. From hiring practices to performance metrics, discover what works.",content:"",image:"/zendesk-slackbot.png",category:"Leadership",tags:["team-building","support","leadership","scaling"],date:"2025-01-15",readTime:8,author:"David Larsen"},{id:3,title:"The Art of Technical Troubleshooting: A Support Leader's Guide",slug:"art-of-technical-troubleshooting-guide",excerpt:"Debugging complex technical issues requires more than just technical knowledge. Here's how to build systematic approaches that work every time.",content:"",image:"/customer-success.png",category:"Technical",tags:["troubleshooting","technical-support","processes","debugging"],date:"2024-12-20",readTime:12,author:"David Larsen"},{id:4,title:"Customer Success Metrics That Actually Matter",slug:"customer-success-metrics-that-matter",excerpt:"Move beyond vanity metrics to track what really drives customer satisfaction and business growth. A deep dive into meaningful KPIs.",content:"",image:"/markdowner.png",category:"Strategy",tags:["metrics","customer-success","kpis","analytics"],date:"2024-12-10",readTime:6,author:"David Larsen"},{id:5,title:"Automation vs. Human Touch: Finding the Right Balance",slug:"automation-vs-human-touch-balance",excerpt:"When should you automate customer support processes, and when is the human touch irreplaceable? Learn to make these critical decisions.",content:"",image:"/pro.png",category:"Technology",tags:["automation","ai","customer-experience","process-improvement"],date:"2024-11-25",readTime:10,author:"David Larsen"},{id:6,title:"Remote Team Leadership: Lessons from Baltimore",slug:"remote-team-leadership-lessons",excerpt:"Managing distributed support teams requires different skills. Here are the strategies that work for building culture and maintaining performance remotely.",content:"",image:"/threeo.jpg",category:"Leadership",tags:["remote-work","team-culture","management","distributed-teams"],date:"2024-11-10",readTime:7,author:"David Larsen"},{id:7,title:"API Documentation: A Support Team's Secret Weapon",slug:"api-documentation-support-secret-weapon",excerpt:"Great API docs don't just help developers—they empower support teams to solve complex technical issues faster. Here's how to leverage them.",content:"",image:"/threeo.jpg",category:"Technical",tags:["api","documentation","technical-support","developer-tools"],date:"2024-10-28",readTime:9,author:"David Larsen"}],Y={class:"max-w-6xl mx-auto"},J={key:0,class:"mb-16"},ee={class:"bg-white rounded-lg shadow-xl overflow-hidden"},te={class:"md:flex"},oe={class:"md:w-1/2"},se=["src","alt"],ae={class:"md:w-1/2 p-8"},re={class:"flex items-center text-sm text-gray-500 mb-4"},ne={class:"bg-secondary text-white px-3 py-1 rounded-full text-xs font-medium mr-4"},ie=["datetime"],le={class:"text-2xl font-bold text-primary mb-4"},de={class:"text-gray-600 mb-6"},ce={key:0,class:"flex flex-wrap gap-2 mb-6"},ue={key:2,class:"bg-secondary text-white px-6 py-3 rounded-lg hover:bg-secondary/90 transition-colors duration-200 inline-flex items-center font-medium cursor-pointer"},he={class:"mb-8"},pe={class:"flex flex-col sm:flex-row gap-4 items-center justify-between"},me={class:"flex flex-wrap gap-2"},ge=["onClick"],fe={class:"relative"},ye={class:"grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12"},we={key:1,class:"text-center py-12"},ve={key:2,class:"text-center"},Se={__name:"blog",setup(r){R({title:"Blog",meta:[{name:"description",content:"David Larsen's blog on customer support, team leadership, technology, and professional insights from Baltimore."}]});const m=k(X),u=k("All"),l=k(""),g=f(()=>[...m.value].sort((c,t)=>new Date(t.date)-new Date(c.date))),n=f(()=>g.value[0]||null),C=f(()=>["All",...new Set(m.value.map(t=>t.category))]),b=f(()=>{let c=g.value.slice(1);if(u.value!=="All"&&(c=c.filter(t=>t.category===u.value)),l.value){const t=l.value.toLowerCase();c=c.filter(p=>p.title.toLowerCase().includes(t)||p.excerpt.toLowerCase().includes(t)||p.tags.some(x=>x.toLowerCase().includes(t)))}return c}),L=c=>new Date(c).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return(c,t)=>{const p=S,x=Z;return s(),a("div",Y,[t[8]||(t[8]=e("div",{class:"text-center mb-12"},[e("h1",{class:"text-4xl font-bold text-primary mb-4"},"Blog"),e("p",{class:"text-xl text-gray-600 max-w-2xl mx-auto"}," Thoughts on customer support, team leadership, technology, and everything in between. ")],-1)),o(n)?(s(),a("div",J,[t[4]||(t[4]=e("h2",{class:"text-2xl font-semibold text-primary mb-6"},"Featured Post",-1)),e("div",ee,[e("div",te,[e("div",oe,[e("img",{src:o(n).image,alt:o(n).title,class:"w-full h-64 md:h-full object-cover"},null,8,se)]),e("div",ae,[e("div",re,[e("span",ne,i(o(n).category),1),e("time",{datetime:o(n).date},i(L(o(n).date)),9,ie),t[1]||(t[1]=e("span",{class:"mx-2"},"•",-1)),e("span",null,i(o(n).readTime)+" min read",1)]),e("h3",le,i(o(n).title),1),e("p",de,i(o(n).excerpt),1),o(n).tags?(s(),a("div",ce,[(s(!0),a(y,null,w(o(n).tags,d=>(s(),a("span",{key:d,class:"bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm"}," #"+i(d),1))),128))])):h("",!0),o(n).content?(s(),_(p,{key:1,to:`/${o(n).slug}`,class:"bg-secondary text-white px-6 py-3 rounded-lg hover:bg-secondary/90 transition-colors duration-200 inline-flex items-center font-medium"},{default:T(()=>t[2]||(t[2]=[v(" Read Full Article ",-1),e("svg",{class:"w-5 h-5 ml-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])),_:1,__:[2]},8,["to"])):(s(),a("div",ue,t[3]||(t[3]=[v(" Coming Soon ",-1),e("svg",{class:"w-5 h-5 ml-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])))])])])])):h("",!0),e("div",he,[e("div",pe,[e("div",me,[(s(!0),a(y,null,w(o(C),d=>(s(),a("button",{key:d,onClick:be=>u.value=o(u)===d?"All":d,class:j(["px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200",o(u)===d?"bg-secondary text-white":"bg-gray-100 text-gray-700 hover:bg-gray-200"])},i(d),11,ge))),128))]),e("div",fe,[I(e("input",{"onUpdate:modelValue":t[0]||(t[0]=d=>P(l)?l.value=d:null),type:"text",placeholder:"Search posts...",class:"pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent"},null,512),[[D,o(l)]]),t[5]||(t[5]=e("svg",{class:"absolute left-3 top-2.5 h-5 w-5 text-gray-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1))])])]),e("div",ye,[(s(!0),a(y,null,w(o(b),d=>(s(),_(x,{key:d.id,post:d},null,8,["post"]))),128))]),o(b).length===0?(s(),a("div",we,t[6]||(t[6]=[A('<div class="text-gray-400 mb-4"><svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div><h3 class="text-xl font-medium text-gray-600 mb-2">No posts found</h3><p class="text-gray-500">Try adjusting your search or filter criteria.</p>',3)]))):h("",!0),o(b).length>0?(s(),a("div",ve,t[7]||(t[7]=[e("button",{class:"bg-gray-100 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-200 transition-colors duration-200 font-medium"}," Load More Posts ",-1)]))):h("",!0)])}}};export{Se as default};
