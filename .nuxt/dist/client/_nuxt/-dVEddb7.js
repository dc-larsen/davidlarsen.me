import{r as i,f as w,c as u,o as d,e as f,a as n,g as y,u as l,t as m,h as S,v as C,i as P,j as H,n as L,p as $,_ as j,b as A}from"./uk8ftFZj.js";import{u as T}from"./CdsbflCP.js";const B={class:"mac-window w-full h-[32rem] overflow-hidden"},I={class:"terminal h-full"},R={class:"terminal-content"},D={key:0,class:"output whitespace-pre-wrap mb-2"},W={class:"flex items-center"},z={class:"text-muted"},E={__name:"TerminalWindow",setup(h){const e=i(""),a=i(""),r=i([]),v=i("[david~]$"),c=i(null),t={Help:"help",Clear:"clear",History:"history",About:"whoami",Resume:"skills",Projects:"projects"};w(()=>{e.value=`${p()}
