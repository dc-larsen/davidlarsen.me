  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(post)) {
        ...
        _push(`<div class="prose prose-lg max-w-none mb-12" data-v-7df31d76>${unref(post).content ?? ""}</div><div class="border-t border-gray-200 pt-8" data-v-7df31d76><div class="flex flex-col sm:flex-row justify-between items-center" data-v-7df31d76>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/blog",
...
//# sourceMappingURL=_slug_-B10NWj7s.js.map
