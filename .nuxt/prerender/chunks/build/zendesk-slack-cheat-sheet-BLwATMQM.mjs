...
const _imports_0 = "" + buildAssetsURL("slackbot.BHOtE3VQ.png");
const _imports_1 = "" + buildAssetsURL("sample-slack-post.DeYX-7yl.png");
const _sfc_main = {
...
//# sourceMappingURL=zendesk-slack-cheat-sheet-BLwATMQM.mjs.map
