...
import { mergeProps, ref, unref, useSSRContext } from 'file:///Users/davidlarsen/Downloads/tylernhoward.github.io-develop/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrInterpolate } from 'file:///Users/davidlarsen/Downloads/tylernhoward.github.io-develop/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mac-window w-full h-96 overflow-hidden" }, _attrs))}><div class="mac-window-bar"><div class="mac-circles"><div class="mac-circle"></div></div><div class="mac-title-bar"><span class="text-xs font-medium text-gray-600">[david~]$</span></div></div><div class="terminal h-full"><div class="terminal-content">`);
      if (unref(output)) {
        _push(`<div class="output whitespace-pre-wrap mb-2">${ssrInterpolate(unref(output))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex items-center"><span class="text-muted">${ssrInterpolate(unref(inputLabel))}\xA0</span><input${ssrRenderAttr("value", unref(command))} class="command-input flex-1" autocomplete="off" spellcheck="false"></div></div></div></div>`);
    };
  }
};
...
const _imports_0 = "" + buildAssetsURL("pro.DZ6561Fe.png");
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2c634e6e"]]);

export { index as default };
//# sourceMappingURL=index-Kzrqgocn.mjs.map
