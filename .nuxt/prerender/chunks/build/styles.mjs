...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.DaehVNLS.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=72318ff7&lang.css": () => import('./index-styles.C70JcQRB.mjs').then(interopDefault),
