...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.QTxfKcwk.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=55ca8ecf&lang.css": () => import('./index-styles.t4VAp6Jt.mjs').then(interopDefault),
