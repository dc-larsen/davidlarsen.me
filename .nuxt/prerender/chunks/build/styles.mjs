...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.VbQB-rYW.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=954bcf4c&lang.css": () => import('./index-styles.BJWSPlDE.mjs').then(interopDefault),
