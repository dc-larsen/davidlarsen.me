...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.p9wU24VX.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=45257502&lang.css": () => import('./index-styles.DZGPusHC.mjs').then(interopDefault),
