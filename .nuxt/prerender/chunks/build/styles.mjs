...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.BoevSHci.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=3e3f46a3&lang.css": () => import('./index-styles.FjHef--F.mjs').then(interopDefault),
