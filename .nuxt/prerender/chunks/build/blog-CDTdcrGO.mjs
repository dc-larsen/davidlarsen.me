  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(featuredPost)) {
        _push(`<div class="mb-16"><h2 class="text-2xl font-semibold text-primary mb-6">Featured Post</h2><div class="bg-white rounded-lg shadow-xl overflow-hidden"><div class="md:flex"><div class="md:w-1/2">`);
        if (unref(featuredPost).content) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", unref(featuredPost).image)}${ssrRenderAttr("alt", unref(featuredPost).title)} class="w-full h-64 md:h-full object-cover hover:scale-105 transition-transform duration-300"${_scopeId}>`);
              } else {
                return [
                  createVNode("img", {
...
//# sourceMappingURL=blog-CDTdcrGO.mjs.map
