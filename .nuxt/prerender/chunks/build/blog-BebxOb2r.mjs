...
import { ref, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, createBlock, openBlock, useSSRContext } from 'file:///Users/davidlarsen/Desktop/Projects/davidlarsen.me/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'file:///Users/davidlarsen/Desktop/Projects/davidlarsen.me/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden group" }, _attrs))} data-v-2b14d6a4><div class="relative h-48 sm:h-64 overflow-hidden" data-v-2b14d6a4>`);
      if (__props.post.content) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", __props.post.image)}${ssrRenderAttr("alt", __props.post.title)} class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-v-2b14d6a4${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
        ...
        _push(`<img${ssrRenderAttr("src", __props.post.image)}${ssrRenderAttr("alt", __props.post.title)} class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-v-2b14d6a4>`);
      }
      _push(`<div class="absolute top-4 left-4" data-v-2b14d6a4><span class="bg-secondary text-white px-3 py-1 rounded-full text-sm font-medium" data-v-2b14d6a4>${ssrInterpolate(__props.post.category)}</span></div></div><div class="p-6" data-v-2b14d6a4><div class="flex items-center text-sm text-gray-500 mb-3" data-v-2b14d6a4><time${ssrRenderAttr("datetime", __props.post.date)} data-v-2b14d6a4>${ssrInterpolate(formatDate(__props.post.date))}</time><span class="mx-2" data-v-2b14d6a4>\u2022</span><span data-v-2b14d6a4>${ssrInterpolate(__props.post.readTime)} min read</span></div>`);
      if (__props.post.content) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/blog/${__props.post.slug}`,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="text-xl font-bold text-primary mb-3 line-clamp-2 hover:text-secondary transition-colors duration-200" data-v-2b14d6a4${_scopeId}>${ssrInterpolate(__props.post.title)}</h3>`);
            } else {
              return [
                createVNode("h3", { class: "text-xl font-bold text-primary mb-3 line-clamp-2 hover:text-secondary transition-colors duration-200" }, toDisplayString(__props.post.title), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<h3 class="text-xl font-bold text-primary mb-3 line-clamp-2" data-v-2b14d6a4>${ssrInterpolate(__props.post.title)}</h3>`);
      }
      _push(`<p class="text-gray-600 mb-4 line-clamp-3" data-v-2b14d6a4>${ssrInterpolate(__props.post.excerpt)}</p>`);
      if (__props.post.tags && __props.post.tags.length) {
        _push(`<div class="flex flex-wrap gap-2 mb-4" data-v-2b14d6a4><!--[-->`);
        ssrRenderList(__props.post.tags, (tag) => {
          _push(`<span class="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium" data-v-2b14d6a4> #${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex items-center justify-between" data-v-2b14d6a4>`);
      if (__props.post.content) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/blog/${__props.post.slug}`,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Read More <svg class="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2b14d6a4${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-v-2b14d6a4${_scopeId}></path></svg>`);
            } else {
              return [
        ...
        _push(`<div class="inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200 cursor-pointer" data-v-2b14d6a4> Coming Soon <svg class="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2b14d6a4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-v-2b14d6a4></path></svg></div>`);
      }
      if (__props.post.author) {
        _push(`<div class="text-sm text-gray-500" data-v-2b14d6a4> by ${ssrInterpolate(__props.post.author)}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2b14d6a4"]]);
const blogPosts = [
  {
    id: 1,
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Jam\xF3n croquettes</li>
        <li>Boquerones</li>
        <li>Spinach & Gruy\xE8re croquettes</li>
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-6xl mx-auto" }, _attrs))}><div class="text-center mb-12"><h1 class="text-4xl font-bold text-primary mb-4">Blog</h1><p class="text-xl text-gray-600 max-w-2xl mx-auto"> Thoughts on work and whatever I find interesting. </p></div>`);
      if (unref(featuredPost)) {
        _push(`<div class="mb-16"><h2 class="text-2xl font-semibold text-primary mb-6">Featured Post</h2><div class="bg-white rounded-lg shadow-xl overflow-hidden"><div class="md:flex md:min-h-[400px]"><div class="md:w-1/2 md:flex">`);
        if (unref(featuredPost).content) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/${unref(featuredPost).slug}`,
            class: "block cursor-pointer w-full"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", unref(featuredPost).image)}${ssrRenderAttr("alt", unref(featuredPost).title)} class="w-full h-64 md:h-full md:min-h-[400px] object-cover hover:scale-105 transition-transform duration-300"${_scopeId}>`);
              } else {
                return [
                  createVNode("img", {
        ...
        if (unref(featuredPost).content) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h3 class="text-2xl font-bold text-primary mb-4 hover:text-secondary transition-colors duration-200"${_scopeId}>${ssrInterpolate(unref(featuredPost).title)}</h3>`);
              } else {
                return [
                  createVNode("h3", { class: "text-2xl font-bold text-primary mb-4 hover:text-secondary transition-colors duration-200" }, toDisplayString(unref(featuredPost).title), 1)
                ];
              }
            }),
            _: 1
          ...
          _push(`<h3 class="text-2xl font-bold text-primary mb-4">${ssrInterpolate(unref(featuredPost).title)}</h3>`);
        }
        _push(`<p class="text-gray-600 mb-6">${ssrInterpolate(unref(featuredPost).excerpt)}</p>`);
...
//# sourceMappingURL=blog-BebxOb2r.mjs.map
