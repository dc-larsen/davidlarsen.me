  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(post)) {
        ...
        _push(`<div class="prose prose-lg max-w-none mb-12" data-v-a5b3e9e6>${(_a = unref(post).content) != null ? _a : ""}</div><div class="border-t border-gray-200 pt-8" data-v-a5b3e9e6><div class="flex flex-col sm:flex-row justify-between items-center" data-v-a5b3e9e6>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/blog",
...
//# sourceMappingURL=_slug_-Cn27eYkb.mjs.map
