...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/davidlarsen/Desktop/Projects/davidlarsen.me/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-B31dNvkJ.mjs'),
    children: [
      {
        name: "blog-thoughts-on-leadership",
        path: "thoughts-on-leadership",
        component: () => import('./thoughts-on-leadership-BwMP46Y5.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    path: "/thoughts-on-leadership",
    component: () => import('./thoughts-on-leadership-BmI3xqUt.mjs')
  }
];
