...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'A love letter to the moments where time slows, bends, and climbs an octave higher. Exploring iconic guitar solos from Pink Floyd\'s "Echoes" and Led Zeppelin\'s "Stairway to Heaven."',
    content: true,
    image: '/images/guitar.png',
    category: 'Music',
    tags: ['guitar', 'music', 'pink-floyd', 'led-zeppelin', 'david-gilmour', 'jimmy-page', 'guitar-solos', 'classic-rock'],
    date: '2025-11-09',
    readTime: 6,
    author: 'David Larsen'
  },
