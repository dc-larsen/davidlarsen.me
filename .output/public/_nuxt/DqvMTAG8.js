import{_ as T}from"./DOnICjvF.js";import{_ as B,c as r,o as s,a as t,t as i,e as h,F as y,r as w,f as _,w as S,d as v,g as k,h as f,u as o,i as D,v as P,j as I,k as A,n as j}from"./CFXdjX-3.js";import{u as $}from"./Cpl-oMgA.js";const W={class:"bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden group"},M={class:"relative h-48 sm:h-64 overflow-hidden"},R=["src","alt"],q={class:"absolute top-4 left-4"},F={class:"bg-secondary text-white px-3 py-1 rounded-full text-sm font-medium"},N={class:"p-6"},H={class:"flex items-center text-sm text-gray-500 mb-3"},V=["datetime"],Q={class:"text-xl font-bold text-primary mb-3 line-clamp-2 group-hover:text-secondary transition-colors duration-200"},z={class:"text-gray-600 mb-4 line-clamp-3"},U={key:0,class:"flex flex-wrap gap-2 mb-4"},O={class:"flex items-center justify-between"},E={key:1,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200 cursor-pointer"},G={key:2,class:"text-sm text-gray-500"},Z={__name:"BlogCard",props:{post:{type:Object,required:!0}},setup(a){const m=u=>new Date(u).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return(u,l)=>{const g=T;return s(),r("article",W,[t("div",M,[t("img",{src:a.post.image,alt:a.post.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"},null,8,R),t("div",q,[t("span",F,i(a.post.category),1)])]),t("div",N,[t("div",H,[t("time",{datetime:a.post.date},i(m(a.post.date)),9,V),l[0]||(l[0]=t("span",{class:"mx-2"},"•",-1)),t("span",null,i(a.post.readTime)+" min read",1)]),t("h3",Q,i(a.post.title),1),t("p",z,i(a.post.excerpt),1),a.post.tags&&a.post.tags.length?(s(),r("div",U,[(s(!0),r(y,null,w(a.post.tags,n=>(s(),r("span",{key:n,class:"bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium"}," #"+i(n),1))),128))])):h("",!0),t("div",O,[a.post.content?(s(),_(g,{key:0,to:`/blog/${a.post.slug}`,class:"inline-flex items-center text-secondary hover:text-primary font-medium transition-colors duration-200"},{default:S(()=>l[1]||(l[1]=[v(" Read More ",-1),t("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)])),_:1,__:[1]},8,["to"])):(s(),r("div",E,l[2]||(l[2]=[v(" Coming Soon ",-1),t("svg",{class:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M9 5l7 7-7 7"})],-1)]))),a.post.author?(s(),r("div",G," by "+i(a.post.author),1)):h("",!0)])])])}}},K=B(Z,[["__scopeId","data-v-e32211e5"]]),X=[{id:1,title:"Thoughts on leadership",slug:"thoughts-on-leadership",excerpt:"Short version: I try to make good work easier. Set the intent, raise the floor, and get out of the way. A deep dive into leader-leader thinking and practical approaches to engineering leadership.",content:`
      <blockquote>
