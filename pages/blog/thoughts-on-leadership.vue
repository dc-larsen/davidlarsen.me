  ...
  <article class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <div class="flex flex-wrap items-center text-gray-600 text-sm mb-6">
        ...
        <time datetime="2025-08-11" class="mr-4">
          August 11, 2025
        </time>
        <span class="mr-4">•</span>
      ...
      <div class="flex flex-wrap gap-2 mb-8">
        <span
          v-for="tag in ['leadership', 'management', 'team-culture', 'engineering']"
          :key="tag"
    ...
    <div class="mb-8">
      <img
        src="/images/thoughts-on-leadership.png"
...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: '/images/support-playbooks.png' },
