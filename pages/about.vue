<template>
  <div class="max-w-3xl mx-auto">
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-600">Technical Account Manager · Developer Platforms · Cybersecurity</p>
    </div>
    ...
    <div class="space-y-10">
      ...
      <div class="prose prose-lg text-gray-700 max-w-none space-y-6">
        ...
        <p>
          I work to lift the whole team. I rebuilt our quarterly health check process around AI automation and live product data, which the TAM team uses every quarter. I integrated Linear with HubSpot and Slack so customer asks and bugs stop getting lost. And I built a feedback loop on top of Granola transcripts that grades my own customer calls each week.
        </p>
        <p>
