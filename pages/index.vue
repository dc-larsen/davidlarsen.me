    ...
    <div class="text-center lg:text-left lg:w-1/3">
      <div class="mb-8">
        ...
        <p class="text-lg lg:text-xl text-gray-600 mb-8 leading-relaxed">
          Technical Account Manager @ <img src="/images/socket.png" alt="Socket" class="inline-block h-7 w-auto mx-1 align-text-bottom" />, helping customers build securely and scale with confidence. Outside of work, you'll usually find me exploring Baltimore's food scene or traveling with friends and family.
        </p>
      </div>
